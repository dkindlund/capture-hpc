...
SOAP_SOURCE_STAMP("@(#) soapC.cpp ver 2.7.10 2008-05-20 02:00:07 GMT")
...
SOAP_FMAC3 void * SOAP_FMAC4 soap_getelement(struct soap *soap, int *type)
{
	...
	case SOAP_TYPE_ns__test:
		return soap_in_ns__test(soap, NULL, NULL, "ns:test");
	case SOAP_TYPE_ns__testResponse:
		return soap_in_ns__testResponse(soap, NULL, NULL, "ns:testResponse");
	...
	{	const char *t = soap->type;
		...
		if (!soap_match_tag(soap, t, "ns:test"))
		{	*type = SOAP_TYPE_ns__test;
			return soap_in_ns__test(soap, NULL, NULL, NULL);
		}
		if (!soap_match_tag(soap, t, "ns:testResponse"))
		{	*type = SOAP_TYPE_ns__testResponse;
			return soap_in_ns__testResponse(soap, NULL, NULL, NULL);
		}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_putelement(struct soap *soap, const void *ptr, const char *tag, int id, int type)
{
	...
	case SOAP_TYPE_ns__test:
		return soap_out_ns__test(soap, tag, id, (const struct ns__test *)ptr, "ns:test");
	case SOAP_TYPE_ns__testResponse:
		return soap_out_ns__testResponse(soap, tag, id, (const struct ns__testResponse *)ptr, "ns:testResponse");
	case SOAP_TYPE_ns__add:
...
SOAP_FMAC3 void SOAP_FMAC4 soap_markelement(struct soap *soap, const void *ptr, int type)
{
	...
	case SOAP_TYPE_ns__subResponse:
		...
		break;
	case SOAP_TYPE_ns__test:
		soap_serialize_ns__test(soap, (const struct ns__test *)ptr);
		break;
	case SOAP_TYPE_ns__testResponse:
		soap_serialize_ns__testResponse(soap, (const struct ns__testResponse *)ptr);
		break;
	case SOAP_TYPE_ns__add:
...
SOAP_FMAC3 void * SOAP_FMAC4 soap_instantiate(struct soap *soap, int t, const char *type, const char *arrayType, size_t *n)
{
	...
	case SOAP_TYPE_ns__testResponse:
		return (void*)soap_instantiate_ns__testResponse(soap, -1, type, arrayType, n);
	case SOAP_TYPE_ns__test:
		return (void*)soap_instantiate_ns__test(soap, -1, type, arrayType, n);
	case SOAP_TYPE_ns__subResponse:
...
{	switch (p->type)
	...
	case SOAP_TYPE_ns__testResponse:
		if (p->size < 0)
			delete (struct ns__testResponse*)p->ptr;
		else
			delete[] (struct ns__testResponse*)p->ptr;
		break;
	case SOAP_TYPE_ns__test:
		if (p->size < 0)
			delete (struct ns__test*)p->ptr;
		else
			delete[] (struct ns__test*)p->ptr;
		break;
	case SOAP_TYPE_ns__subResponse:
...
SOAP_FMAC3 void SOAP_FMAC4 soap_default_ns__test(struct soap *soap, struct ns__test *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	soap_default_string(soap, &a->a);
}

SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns__test(struct soap *soap, const struct ns__test *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	soap_serialize_string(soap, &a->a);
}

SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns__test(struct soap *soap, const struct ns__test *a, const char *tag, const char *type)
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, tag, SOAP_TYPE_ns__test);
	if (soap_out_ns__test(soap, tag, id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}

SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns__test(struct soap *soap, const char *tag, int id, const struct ns__test *a, const char *type)
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__test), type))
		return soap->error;
...
SOAP_FMAC3 struct ns__test * SOAP_FMAC4 soap_get_ns__test(struct soap *soap, struct ns__test *p, const char *tag, const char *type)
{
	if ((p = soap_in_ns__test(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}

SOAP_FMAC3 struct ns__test * SOAP_FMAC4 soap_in_ns__test(struct soap *soap, const char *tag, struct ns__test *a, const char *type)
{
	short soap_flag_a = 1;
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct ns__test *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_ns__test, sizeof(struct ns__test), 0, NULL, NULL, NULL);
	if (!a)
		return NULL;
	soap_default_ns__test(soap, a);
	if (soap->body && !*soap->href)
	{
		for (;;)
		{	soap->error = SOAP_TAG_MISMATCH;
	...
	{	a = (struct ns__test *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_ns__test, 0, sizeof(struct ns__test), 0, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
SOAP_FMAC5 struct ns__test * SOAP_FMAC6 soap_new_ns__test(struct soap *soap, int n)
{	return soap_instantiate_ns__test(soap, n, NULL, NULL, NULL);
}

SOAP_FMAC5 void SOAP_FMAC6 soap_delete_ns__test(struct soap *soap, struct ns__test *p)
{	soap_delete(soap, p);
}

SOAP_FMAC3 struct ns__test * SOAP_FMAC4 soap_instantiate_ns__test(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate_ns__test(%d, %s, %s)\n", n, type?type:"", arrayType?arrayType:""));
	struct soap_clist *cp = soap_link(soap, NULL, SOAP_TYPE_ns__test, n, soap_fdelete);
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)new struct ns__test;
		if (size)
			*size = sizeof(struct ns__test);
	}
	else
	{	cp->ptr = (void*)new struct ns__test[n];
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
		if (size)
			*size = n * sizeof(struct ns__test);
	}
		DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p\n", cp->ptr));
	return (struct ns__test*)cp->ptr;
}
SOAP_FMAC3 void SOAP_FMAC4 soap_copy_ns__test(struct soap *soap, int st, int tt, void *p, size_t len, const void *q, size_t n)
{
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copying struct ns__test %p -> %p\n", q, p));
	*(struct ns__test*)p = *(struct ns__test*)q;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_default_ns__testResponse(struct soap *soap, struct ns__testResponse *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	a->result = NULL;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns__testResponse(struct soap *soap, const struct ns__testResponse *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	soap_serialize_PointerTostring(soap, &a->result);
}

SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns__testResponse(struct soap *soap, const struct ns__testResponse *a, const char *tag, const char *type)
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, tag, SOAP_TYPE_ns__testResponse);
	if (soap_out_ns__testResponse(soap, tag, id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}

SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns__testResponse(struct soap *soap, const char *tag, int id, const struct ns__testResponse *a, const char *type)
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__testResponse), type))
		return soap->error;
...
SOAP_FMAC3 struct ns__testResponse * SOAP_FMAC4 soap_get_ns__testResponse(struct soap *soap, struct ns__testResponse *p, const char *tag, const char *type)
{
	if ((p = soap_in_ns__testResponse(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}

SOAP_FMAC3 struct ns__testResponse * SOAP_FMAC4 soap_in_ns__testResponse(struct soap *soap, const char *tag, struct ns__testResponse *a, const char *type)
{
	short soap_flag_result = 1;
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct ns__testResponse *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_ns__testResponse, sizeof(struct ns__testResponse), 0, NULL, NULL, NULL);
	if (!a)
		return NULL;
	soap_default_ns__testResponse(soap, a);
	if (soap->body && !*soap->href)
	{
		for (;;)
		{	soap->error = SOAP_TAG_MISMATCH;
	...
	{	a = (struct ns__testResponse *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_ns__testResponse, 0, sizeof(struct ns__testResponse), 0, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
SOAP_FMAC5 struct ns__testResponse * SOAP_FMAC6 soap_new_ns__testResponse(struct soap *soap, int n)
{	return soap_instantiate_ns__testResponse(soap, n, NULL, NULL, NULL);
}

SOAP_FMAC5 void SOAP_FMAC6 soap_delete_ns__testResponse(struct soap *soap, struct ns__testResponse *p)
{	soap_delete(soap, p);
}

SOAP_FMAC3 struct ns__testResponse * SOAP_FMAC4 soap_instantiate_ns__testResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate_ns__testResponse(%d, %s, %s)\n", n, type?type:"", arrayType?arrayType:""));
	struct soap_clist *cp = soap_link(soap, NULL, SOAP_TYPE_ns__testResponse, n, soap_fdelete);
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)new struct ns__testResponse;
		if (size)
			*size = sizeof(struct ns__testResponse);
	}
	else
	{	cp->ptr = (void*)new struct ns__testResponse[n];
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
		if (size)
			*size = n * sizeof(struct ns__testResponse);
	}
		DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p\n", cp->ptr));
	return (struct ns__testResponse*)cp->ptr;
}
SOAP_FMAC3 void SOAP_FMAC4 soap_copy_ns__testResponse(struct soap *soap, int st, int tt, void *p, size_t len, const void *q, size_t n)
{
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copying struct ns__testResponse %p -> %p\n", q, p));
	*(struct ns__testResponse*)p = *(struct ns__testResponse*)q;
}
