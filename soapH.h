...
#define SOAP_TYPE_ns__test (14)
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_default_ns__test(struct soap*, struct ns__test *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns__test(struct soap*, const struct ns__test *);
SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns__test(struct soap*, const struct ns__test *, const char*, const char*);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns__test(struct soap*, const char*, int, const struct ns__test *, const char*);
SOAP_FMAC3 struct ns__test * SOAP_FMAC4 soap_get_ns__test(struct soap*, struct ns__test *, const char*, const char*);
SOAP_FMAC3 struct ns__test * SOAP_FMAC4 soap_in_ns__test(struct soap*, const char*, struct ns__test *, const char*);
SOAP_FMAC5 struct ns__test * SOAP_FMAC6 soap_new_ns__test(struct soap*, int);
SOAP_FMAC5 void SOAP_FMAC6 soap_delete_ns__test(struct soap*, struct ns__test*);
SOAP_FMAC3 struct ns__test * SOAP_FMAC4 soap_instantiate_ns__test(struct soap*, int, const char*, const char*, size_t*);
SOAP_FMAC3 void SOAP_FMAC4 soap_copy_ns__test(struct soap*, int, int, void*, size_t, const void*, size_t);

#ifndef SOAP_TYPE_ns__testResponse
#define SOAP_TYPE_ns__testResponse (13)
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_default_ns__testResponse(struct soap*, struct ns__testResponse *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns__testResponse(struct soap*, const struct ns__testResponse *);
SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns__testResponse(struct soap*, const struct ns__testResponse *, const char*, const char*);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns__testResponse(struct soap*, const char*, int, const struct ns__testResponse *, const char*);
SOAP_FMAC3 struct ns__testResponse * SOAP_FMAC4 soap_get_ns__testResponse(struct soap*, struct ns__testResponse *, const char*, const char*);
SOAP_FMAC3 struct ns__testResponse * SOAP_FMAC4 soap_in_ns__testResponse(struct soap*, const char*, struct ns__testResponse *, const char*);
SOAP_FMAC5 struct ns__testResponse * SOAP_FMAC6 soap_new_ns__testResponse(struct soap*, int);
SOAP_FMAC5 void SOAP_FMAC6 soap_delete_ns__testResponse(struct soap*, struct ns__testResponse*);
SOAP_FMAC3 struct ns__testResponse * SOAP_FMAC4 soap_instantiate_ns__testResponse(struct soap*, int, const char*, const char*, size_t*);
SOAP_FMAC3 void SOAP_FMAC4 soap_copy_ns__testResponse(struct soap*, int, int, void*, size_t, const void*, size_t);
